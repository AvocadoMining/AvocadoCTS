 ...
 */
contract ContinuousTokenSale {
  using SafeMath for uint256;

  // The token being sold
  DetailedERC827Token public token;
  ...
  function Crowdsale(uint256 _startTime, uint256 _rate, address _wallet, DetailedERC827Token _token) public {
